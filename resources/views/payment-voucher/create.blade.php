...
<div class="col-12 grid-margin createtable">
              <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col-md-6">
                                 <h4 class="card-title">New Payment Voucher</h4>
                        </div>
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{ route('payment-voucher.store') }}" method="post" enctype="multipart/form-data"  >
                          {{csrf_field()}}
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="date" class="form-control"  name="in_date"  required="true" value="{{old('in_date')}}" />
                          </div>
                        </div>
                      </div>
                   ...
                   @endforeach
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" placeholder="Vat" id="vat_amount" name="vat_amount" required="true"  value="{{old('vat_amount')}}"  />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Vat" id="total_amount" name="total_amount" required="true"  value="{{old('total_amount')}}"  readonly  />
                          </div>
                        </div>
                      </div>
