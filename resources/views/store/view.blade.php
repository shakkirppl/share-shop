  ...
  <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="row">
                  ...
                  <img src="{{url('/uploads/store/logo/'.$store->logo) }}" alt="" width="150px" height="150px">
                  </p>
 ...
 <a href="{{url('store-active/'.$store->id)}}" class="btn btn-success">Active</a>
            ...
            <hr>
                  ...
                  <div class="table-responsive">
                    ...
                    <tr>
                    @if($pending_days<'0')
                                        <td><label style="color:red;">Subscription Expired</label></td>
                                        <td><label style="color:red;">({{$pending_days=$pending_days*-1}})</label></td>  
                                        @else
                                        <td> <lable style="color: green;">Subscription Days</label></td>
                                        <td> <lable style="color: green;">({{$pending_days}})</label>@if($store->buffer_days>=$pending_days)<label style="color:red;">In Buffer Days </label>@endif</td>  
                                        @endif
                                        </tr>
                                        <tr>
                                        <td>Buffer Days</td>
                                        <td>{{$store->buffer_days}}</td>      
                                        </tr>
                                        <tr>
                                        <td>Name</td>
                                        <td>{{$store->name}}</td>      
