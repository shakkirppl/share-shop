              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-6 col-md-6 col-sm-6 col-xs-12" >
                             <h4 class="card-title">Receipt Voucher Report</h4>
                    </div>
                   
                       
                   
                </div>
                <form class="form-sample"  action="{{url('receipt-voucher-report')}}" method="get" >
                          {{csrf_field()}}
                    <div class="row">
                    ...
                    <table class="table table-hover" id="value-table">
                      ...
                      @if(count($results))
                        ...
                        <tr id="">
                            ...
                            <td class="name">@foreach($data->receipt as $res){{$res->name}}@endforeach</td>
